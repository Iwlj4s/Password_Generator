...
```
curl -O -L https://github.com/Iwlj4s/Password_Generator/raw/master/Password_Generator_Setup.exe
```
...
```
wget https://github.com/Iwlj4s/Password_Generator/raw/master/Password_Generator_Setup.exe
```
* You can use -o and -L in the same way

This will follow the same process of downloading and saving the Password_Generator_Setup.exe file from the repository.
